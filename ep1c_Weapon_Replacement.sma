...
#define wmPrefix "^4[ep1c gaming Brasil]^1"
...
public plugin_init()
{
	...
	register_clcmd("say /skins", "desativar_armas")
	register_clcmd("say_team /skins", "desativar_armas")
}
...
public desativar_armas(id)
{
	...
	if(g_weapons[id] == true)
	{
		...
		client_print_color(id, print_team_red, "%s Skins de armas ^3desativadas^3.", wmPrefix);
		client_print_color(0, id, "%s ^3%s^1 desativou as ^4skins de armas^1 com o comando ^4/skins^1", wmPrefix, szName);
	}
	else if(g_weapons[id] == false)
	{
		g_weapons[id] = true;
                       
		client_print_color(id, print_team_blue, "%s Skins de armas ^4ativadas^1.", wmPrefix);
		client_print_color(0, id, "%s ^3%s^1 ativou as ^4skins de armas^1 com o comando ^4/skins^1.", wmPrefix, szName);
	}
}
