...
public xDeathMsg()
{
	...
	if(equal(xWpn, "knife") && is_user_alive(xKiller))
    {
		...
		set_hudmessage(150, 150, 0, 0.02, 0.76, 2, 0.3, 7.0, 0.1, 0.2)
		ShowSyncHudMsg(0, g_MsgSync, "%s... Teve seu FRAG resetado^nPois morreu na faca por: %s...!", xNameVic, xNameKiller)
