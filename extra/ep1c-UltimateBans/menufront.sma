...
AddDefaultMenus()
{
	...
	// ----- Beginning of Edit -----
	AddMenuLang("BAN_PLAYER", "amx_banmenu", get_clcmd_flags("amx_banmenu", flags) ? flags : ADMIN_BAN, "Ultimate Bans") // Replace with "Players Menu" to Reset to Defaults
	AddMenuLang("UNBAN_PLAYER", "amx_unbanmenu", get_clcmd_flags("amx_unbanmenu", flags) ? flags : ADMIN_BAN, "Ultimate Bans")
	// ----- End of Edit -----
