...
public sXeMenu(id)
{
	...
	if(cs_get_user_buyzone(id))
        ...
        client_print_color(id, print_team_default, "^4[%s]^1 Tem^4 %i^1 steam -^4 %i^1 no-steam -^4 %i^1 com sxe e^4 %i^1 bots.", Tag, Contar[2], Contar[1], Contar[0], Contar[3])
