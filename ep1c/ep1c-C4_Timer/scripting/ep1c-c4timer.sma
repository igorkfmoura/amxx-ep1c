...
public plugin_init()
{
	register_plugin("ep1c: C4 Timer", PLUGIN_VERSION, "OciXCrom")
	register_cvar("ep1c: C4 Timer", PLUGIN_VERSION, FCVAR_SERVER|FCVAR_SPONLY|FCVAR_UNLOGGED)
...
ReadFile()
{
	...
	add(szFilename, charsmax(szFilename), "/ep1c-c4timer.ini")
