...
public plugin_init()
{
	register_plugin("ep1c: Anti Ping", "1.3","OLO & iceeedR")
	register_cvar("ep1c: Anti Ping", "1.3", FCVAR_SERVER | FCVAR_SPONLY |FCVAR_UNLOGGED )

	register_dictionary("ep1c-AntiPing.txt")
